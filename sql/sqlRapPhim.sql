...
('PH001', N'Người Hùng Thời Tận Thế', 'LPh001', N'Sau một trận bão mặt trời tàn phá Trái Đất, nhân loại rơi vào hỗn loạn. Một thợ săn kho báu liều lĩnh lên đường tìm Mona Lisa nhưng trở thành người hùng của nhân loại.', 105, 2025, N'img/posters/Nguoi_Hung_Thoi_Tan_The.jpg'),
('PH002', N'Cuộc Chiến Giữa Các Thế Giới', 'LPh005', N'Một chuyên gia an ninh mạng phát hiện chính phủ che giấu một thực thể bí ẩn từ thế giới khác.', 91, 2025, N'img/posters/Cuoc_Chien_Giua_Cac_The_Gioi.jpg'),
('PH003', N'Culpa Nuestra', 'LPh004', N'Câu chuyện tình cảm phức tạp giữa Noah và Nick khi định mệnh đưa họ gặp lại sau nhiều năm chia tay.', 112, 2025, N'img/posters/Culpa_Nuestra.jpg'),
('PH004', N'Marvels: Secret Wars', 'LPh001', N'Các siêu anh hùng Marvel hợp lực để ngăn chặn đa vũ trụ sụp đổ trong trận chiến cuối cùng.', 135, 2025, N'img/posters/Marvels_Secret_Wars.jpg'),
('PH005', N'Inside Out 2', 'LPh006', N'Riley bước vào tuổi dậy thì với những cảm xúc mới đầy hỗn loạn và bất ngờ.', 95, 2024, N'img/posters/Inside_Out_2.jpg'),
('PH006', N'Nhà Bà Nữ 2', 'LPh002', N'Tiếp nối thành công phần đầu, câu chuyện hài hước nhưng cảm động về gia đình bà Nữ.', 120, 2025, N'img/posters/Nha_Ba_Nu_2.jpg'),
('PH007', N'The Batman: Rebirth', 'LPh001', N'Batman tái sinh trong một Gotham hỗn loạn sau khi Joker trốn thoát khỏi Arkham.', 140, 2025, N'img/posters/The_Batman_Rebirth.jpg'),
('PH008', N'Frozen 3', 'LPh006', N'Anna và Elsa bắt đầu chuyến phiêu lưu mới khi một bí mật về nguồn gốc băng giá được tiết lộ.', 102, 2026, N'img/posters/Frozen_3.jpg'),
('PH009', N'Mất Tích Ở Đà Lạt', 'LPh003', N'Một nhóm bạn trẻ mất tích bí ẩn trong rừng thông Đà Lạt, nơi tồn tại truyền thuyết rùng rợn.', 98, 2025, N'img/posters/Mat_Tich_o_Da_Lat.jpg'),
('PH010', N'The Lion King Reborn', 'LPh006', N'Câu chuyện kinh điển được làm lại với công nghệ CGI chân thực và âm nhạc mới.', 118, 2024, N'img/posters/The_Lion_King_Reborn.jpg'),
('PH011', N'Thanh Xuân Rực Rỡ', 'LPh004', N'Một cô gái tỉnh lẻ lên thành phố theo đuổi ước mơ ca hát và tìm thấy tình yêu.', 107, 2024, N'img/posters/Thanh_Xuan_Ruc_Ro.jpg'),
('PH012', N'Avengers: Legacy', 'LPh001', N'Đội Avengers thế hệ mới xuất hiện để bảo vệ Trái Đất khỏi mối đe dọa vũ trụ.', 150, 2026, N'img/posters/Avengers_Legacy.jpg'),
('PH013', N'Nhà Không Bán', 'LPh003', N'Câu chuyện kinh dị Việt Nam về một ngôi nhà ma ám và lời nguyền gia tộc.', 102, 2022, N'img/posters/Nha_Khong_Ban.jpg'),
('PH014', N'Sonic 3', 'LPh005', N'Sonic cùng bạn bè đối đầu kẻ thù mới từ không gian, mở ra cuộc phiêu lưu tốc độ cao.', 115, 2025, N'img/posters/Sonic_3.jpg'),
('PH015', N'Titanic 2', 'LPh004', N'Một chuyến tàu xa hoa mới được xây dựng, nhưng lịch sử có lặp lại?', 125, '2025', N'img/posters/Titanic_2.jpg'),
('PH016', N'Spider-Man: Beyond Time', 'LPh001', N'Spiderman du hành qua các chiều không gian để ngăn chặn sự sụp đổ đa vũ trụ.', 130, 2026, N'img/posters/SpiderMan_Beyond_Time.jpg'),
('PH017', N'Hài Kịch Cuộc Đời', 'LPh002', N'Một chàng diễn viên hài thất bại tìm thấy cơ hội thứ hai khi bước lên sân khấu cuộc đời.', 90, 2024, N'img/posters/Hai_Kich_Cuoc_Doi.jpg'),
('PH018', N'Avatar: The Seed', 'LPh005', N'Một thế hệ mới của người Na’vi bắt đầu hành trình bảo vệ hành tinh Pandora.', 155, 2026, N'img/posters/Avatar_The_Seed.jpg'),
('PH019', N'IT: Legacy', 'LPh003', N'Thị trấn Derry lại chìm trong ác mộng khi nỗi sợ cũ sống lại cùng thế hệ mới.', 128, 2025, N'img/posters/IT_Legacy.jpg'),
('PH020', N'Bay Cùng Yêu Thương', 'LPh004', N'Một tiếp viên hàng không tìm thấy ý nghĩa cuộc sống qua những hành khách đặc biệt.', 101, 2024, N'img/posters/Bay_Cung_Yeu_Thuong.jpg'),
('PH021', N'Bad Boys 5', 'LPh001', N'Hai cảnh sát già tiếp tục phá án trong phi vụ cuối cùng trước khi nghỉ hưu.', 122, 2025, N'img/posters/Bad_Boys_5.jpg'),
('PH022', N'Kung Fu Panda 4', 'LPh006', N'Po quay lại với sứ mệnh đào tạo Thần Long chiến binh kế tiếp.', 98, 2024, N'img/posters/KungFu_Panda_4.jpg'),
('PH023', N'Trò Chơi Sinh Tồn', 'LPh003', N'Một nhóm người bị nhốt trong trò chơi thực tế ảo mà sinh mạng là cái giá phải trả.', 115, 2025, N'img/posters/Tro_Choi_Sinh_Ton.jpg'),
('PH024', N'Ngày Mai Bình Yên', 'LPh004', N'Câu chuyện về lòng nhân ái và sự tha thứ giữa những con người tổn thương.', 100, 2023, N'img/posters/Ngay_Mai_Binh_Yen.jpg'),
('PH025', N'Fast & Furious 11', 'LPh001', N'Dominic Toretto cùng đội của anh đối đầu kẻ thù nguy hiểm nhất từ trước đến nay.', 145, 2025, N'img/posters/Fast_Furious_11.jpg'),
('PH026', N'Vùng Đất Câm Lặng 3', 'LPh003', N'Tiếp tục câu chuyện sinh tồn trong thế giới bị thống trị bởi quái vật âm thanh.', 108, 2024, N'img/posters/Vung_Dat_Cam_Lang_3.jpg'),
('PH027', N'Hành Trình Kỳ Diệu', 'LPh005', N'Một cậu bé cùng chú chó máy khám phá thế giới kỳ diệu bên ngoài Trái Đất.', 110, 2024, N'img/posters/Hanh_Trinh_Ky_Dieu.jpg'),
('PH028', N'Minions: Rise Again', 'LPh006', N'Các Minion tiếp tục hành trình nghịch ngợm với ông chủ Gru thời trẻ.', 89, 2024, N'img/posters/Minions_Rise_Again.jpg'),
('PH029', N'Lật Mặt 7: Cú Lừa', 'LPh002', N'Một bộ phim Việt đầy kịch tính xen lẫn hài hước của Lý Hải.', 123, 2025, N'img/posters/Lat_Mat_7_Cu_Lua.jpg'),
('PH030', N'Godzilla x Kong: The New Empire', 'LPh001', N'Hai quái thú huyền thoại hợp lực đối đầu mối đe dọa từ lòng đất.', 138, 2024, N'img/posters/Godzilla_x_Kong_The_New_Empire.jpg');
